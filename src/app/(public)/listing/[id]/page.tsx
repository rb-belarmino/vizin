          ...
          <div className="bg-card border rounded-xl p-6 shadow-sm">
            ...
            {!session?.user?.id ? (
              <div className="text-center p-6 bg-muted/50 rounded-lg">
                ...
                <Link href="/login">
                  <Button className="brand-gradient text-white">Fazer Login</Button>
                </Link>
              </div>
            ) : isProvider ? (
              <div className="text-center p-6 bg-muted/50 rounded-lg">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              {listing.ratingAverage !== undefined && (
                <div className="flex items-center gap-1.5 px-3 py-1 bg-muted rounded-full">
                  ...
                  <span className="font-bold text-sm text-foreground">{listing.ratingAverage}</span>
                  <span className="text-xs text-muted-foreground font-medium">({listing.reviewCount})</span>
                </div>
              )}
            </div>
