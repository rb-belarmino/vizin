...
CREATE TABLE "ServiceListing" (
    ...
    "portfolioImageKey" TEXT NOT NULL,
    "priceBaseline" TEXT,
    "whatsappNumber" TEXT,
    "instagramHandle" TEXT,
    "visibilityStatus" TEXT NOT NULL DEFAULT 'Public',
    "showApartment" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE UNIQUE INDEX "Review_authorId_serviceListingId_key" ON "Review"("authorId", "serviceListingId");
