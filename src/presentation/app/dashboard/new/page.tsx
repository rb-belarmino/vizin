...
const serviceSchema = z.object({
  ...
  description: z
    .string()
    .min(10, 'A descrição precisa ser mais detalhada (mínimo 10 caracteres).'),
    ...
    <div className="container mx-auto py-10 px-4 md:px-6 max-w-3xl">
      ...
      <Card className="shadow-lg border-t-4 border-t-indigo-600">
        <CardHeader>
          ...
          <CardDescription>
            Preencha os detalhes do serviço que você deseja oferecer aos seus
            vizinhos.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Ex: Manicure, Aulas de Inglês, Conserto de PC..."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 shadow-sm bg-slate-50">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Deixe ativado para que o serviço fique visível na
                        Vitrine Pública.
                      </FormDescription>
                    </div>
                    <FormControl>
